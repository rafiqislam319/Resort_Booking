/*-----------------------------------------------------------------------------------
    Template Name: <span class="btg-text">Protectk</span> IT solution html template
...
(function ($) {
  ...
  $('.quantity-right-plus').on('click', function(e) {
    ...
    e.preventDefault();
    // Get the field name
    var quantity = parseInt($('.quantityval').val());

    // If is not undefined

    $('.quantityval').val(quantity + 1);
  ...
  $('.quantity-right-plus1').on('click', function(e) {
  ...
  $('.quantity-left-minus1').on('click', function(e) {
