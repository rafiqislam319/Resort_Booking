...
<link rel="stylesheet" href="<?php echo asset('/public/admin/plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css');?>">
<script src="<?php echo asset('/public/admin/plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js');?>"></script>
<script>
  $(function () {
    // Summernote
