...
{{--                                    <h5>{{ $item->name }}</h5>--}}
{{--                                    <h5>{{ $getLang() == 'en' ? $item->name : 'service_title_bangla' }}</h5>--}}
                                    <h5>{{ $getLang() == 'en' ? $item->name : $Model('Post')::customField('service_title_bangla', $item->id) }}</h5>
                                    <div class="w-100">

                                            <?php
//                                            $service_des = $Model('Post')::customField('service_sub_title', $item->id);
                                            $service_des =  $getLang() == 'en' ? $Model('Post')::customField('service_sub_title', $item->id) : $Model('Post')::customField('service_subtitle_bangla', $item->id);
