...
{{--                                        <h4>{{ $item->name  }}</h4>--}}
{{--                                        <h4>{{ $getLang() == 'en' ? $item->name : 'team_title_bangla'  }}</h4>--}}
                                        <h4>{{ $getLang() == 'en' ? $item->name : $Model('Post')::customField('team_title_bangla', $item->id)  }}</h4>
...
{{--                                            <div><strong>Designation: </strong>{{ $Model('Post')::customField('designation', $item->id) }}</div>--}}
                                            <div><strong>{{ $getTeamLocalce->team('designation', $getLang()) }}: </strong>{{ $getLang() == 'en' ? $Model('Post')::customField('designation', $item->id) : $Model('Post')::customField('designation_bangla', $item->id) }}</div>
{{--                                            <div><strong>Degree: </strong>{{ $Model('Post')::customField('degrees', $item->id) }}</div>--}}
{{--                                            <div><strong>Degree: </strong>{{ $getLang() == 'en' ? $Model('Post')::customField('degrees', $item->id) : 'degree_bangla' }}</div>--}}
                                            <div><strong>{{$getTeamLocalce->team('degrees', $getLang())}}: </strong>{{ $getLang() == 'en' ? $Model('Post')::customField('degrees', $item->id) : $Model('Post')::customField('degree_bangla', $item->id) }}</div>
...
{{--                                            <div><strong>Chamber Location: </strong>{{ $getLang() == 'en' ? $Model('Post')::customField('chamber_location', $item->id) : 'chamber_location_bangla' }}</div>--}}
                                            <div><strong>{{$getTeamLocalce->team('chamber_location', $getLang())}}: </strong>{{ $getLang() == 'en' ? $Model('Post')::customField('chamber_location', $item->id) : $Model('Post')::customField('chamber_location_bangla', $item->id) }}</div>
                                        </div>
                                    </div>
                                </div>
                            </a>
