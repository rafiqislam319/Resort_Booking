...
<div class="container mt-5">
    ...
    <div class="row">
        <div class="col-md-8">
{{--            <h1>{{ $page->name }}</h1>--}}
            <h1>{{ $getLang() == 'en' ? $page->name : $Model('Post')::customField('blog_title_bangla', $page->id) }}</h1>
...
{{--            <p>{!! $page->description !!} </p>--}}
            <p>{!! $getLang() == 'en' ? $page->description : $Model('Post')::customField('blog_description_bangla', $page->id) !!} </p>
        </div>
